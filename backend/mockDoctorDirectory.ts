...
const CONTROLLED_DIRECTORY_DEFINITIONS: readonly ControlledDirectoryDefinition[] =
  [
    {
      id: "mock-central-cardiology-csmt",
      specialty: "Cardiology",
      station: "CSMT",
      railLine: "Central",
    },
    {
      id: "mock-central-dermatology-ghatkopar",
      specialty: "Dermatology",
      station: "Ghatkopar",
      railLine: "Central",
    },
    {
      id: "mock-central-orthopedics-bhandup",
      specialty: "Orthopedics",
      station: "Bhandup",
      railLine: "Central",
    },
    {
      id: "mock-central-neurology-thane",
      specialty: "Neurology",
      station: "Thane",
      railLine: "Central",
    },
    ...
    {
      id: "mock-western-pediatrics-andheri",
      specialty: "Pediatrics",
      station: "Andheri",
      railLine: "Western",
    },
    {
      id: "mock-western-ophthalmology-goregaon",
      specialty: "Ophthalmology",
      station: "Goregaon",
      railLine: "Western",
    },
    {
      id: "mock-western-gastroenterology-borivali",
      specialty: "Gastroenterology",
      station: "Borivali",
      railLine: "Western",
    },
    {
      id: "mock-harbour-psychiatry-sewri",
      specialty: "Psychiatry",
      station: "Sewri",
      railLine: "Harbour",
    },
    {
      id: "mock-harbour-endocrinology-chembur",
      specialty: "Endocrinology",
      station: "Chembur",
      railLine: "Harbour",
    },
    {
      id: "mock-harbour-pulmonology-vashi",
      specialty: "Pulmonology",
      station: "Vashi",
      railLine: "Harbour",
    },
    {
      id: "mock-harbour-gynecology-panvel",
...
export const mockDoctorDirectory: MockDoctorDirectoryEntry[] =
  CONTROLLED_DIRECTORY_DEFINITIONS.map(definition => {
    const station = MUMBAI_RAIL_STATIONS.find(
      candidate => candidate.name === definition.station
    );
    const coordinate = MUMBAI_STATION_COORDINATES[definition.station];
    if (!station || !coordinate)
      throw new Error(
        `Missing controlled directory reference data for ${definition.station}`
      );
...
export function filterMockDoctorDirectory(
  filters: MockDoctorDirectoryFilters = {}
) {
  ...
  return mockDoctorDirectory.filter(doctor => {
    ...
    if (filters.railLine && !doctor.railLines.includes(filters.railLine))
      return false;
...
export function getMockDoctorDirectoryFacets() {
  const supportedStations = MUMBAI_RAIL_STATIONS.filter(station =>
    mockDoctorDirectory.some(doctor => doctor.station === station.name)
  );
  return {
    city: "Mumbai" as const,
    specialties: Array.from(
      new Set(mockDoctorDirectory.map(doctor => doctor.specialty))
    ).sort(),
    localities: Array.from(
      new Set(mockDoctorDirectory.map(doctor => doctor.locality))
    ).sort(),

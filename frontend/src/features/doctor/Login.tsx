...
export const DoctorLogin = () => {
  ...
  const login = trpc.doctorAuth.login.useMutation({
    ...
    onError: () =>
      setError("The clinician email or password was not accepted."),
  });
    ...
    >
      <Card style={{ width: "100%", maxWidth: "400px" }}>
        <div style={{ textAlign: "center", marginBottom: "var(--spacing-4)" }}>
          ...
          <p className="caption" style={{ marginTop: "var(--spacing-1)" }}>
            Controlled directory account. Specialist records are not verified
        ...
        >
          ...
          >
            {login.isPending ? "Opening workspace…" : "Doctor sign in"}
          </Button>
        </form>
        <footer
        ...
        >
          <span className="caption">Looking for your patient account?</span>
          <button
            type="button"
